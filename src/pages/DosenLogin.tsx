...
const DosenLogin = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const isValid = ((isEmailLogin && inputLower === validEmail) || (!isEmailLogin && inputLower === validName)) && credentials.password === validPassword;
    ...
    if (isValid) {
      ...
      const expiresAt = now + threeHours;

      // simpan ke localStorage
      localStorage.setItem("dosen_auth", "true");
      localStorage.setItem("dosen_name", "Dede Handayani");
      localStorage.setItem("dosen_expires_at", expiresAt.toString());
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <Card className="w-full max-w-md bg-card/95 backdrop-blur-md border-2 border-primary/30 shadow-2xl hover:shadow-3xl transition-all duration-300">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-base">Masuk untuk mengakses dashboard validasi kegiatan ilmiah</CardDescription>
          </CardHeader>
          <CardContent>
            <form
            ...
            >
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                />
                <p className="text-xs text-muted-foreground">Gunakan nama lengkap atau alamat email</p>
              </div>
              ...
              {/* <div className="pt-4 text-center border-t border-border">
                ...
                <p className="text-xs text-muted-foreground">
                  Nama: <span className="font-medium">Dede Handayani</span>
                  <br />
